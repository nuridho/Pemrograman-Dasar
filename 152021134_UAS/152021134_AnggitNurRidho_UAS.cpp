...
int main(){
    ...
    cout << "====bar atas===" << endl;
    // bar atas
        bar_atas = n * sigmaxy - (sigmax*sigmay);
        cout << bar_atas << endl;
    ...
    oprs_x = sqrt(n * sigmaxkuadrat - jum_sigmaxkuadrat);
    oprs_y = sqrt(n * sigmaykuadrat - jum_sigmaykuadrat);
    bar_bawah = oprs_x * oprs_y;
    ...
    cout << "===Bar Bawah====" << endl;
    cout << bar_bawah << endl;
    // r = (bar_atas) / (bar_bawah);
    r = ((n * sigmaxy) - (sigmax*sigmay)) / (sqrt((n * sigmaxkuadrat) - jum_sigmaxkuadrat) * sqrt((n * sigmaykuadrat) - jum_sigmaykuadrat)); 
    cout << "=====Hasil R======" << endl;
    cout << "r = " << r << endl;
